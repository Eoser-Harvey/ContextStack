...
```bash
# 如果目录不存在则创建
mkdir "D:\MyFile\AI\ContextStack\VSCode Config"
mkdir "D:\MyFile\AI\ContextStack\VSCode Config\history"
```
...
set BACKUP_PATH=D:\MyFile\AI\ContextStack\VSCode Config
```
