...
### settings.json
- **路径**: `D:/Ai/VSCode Config/settings.json`
...
### 恢复配置（如果VSCode配置丢失）：
```cmd
copy D:\Ai\VSCode Config\settings.json C:\Users\h31280\AppData\Roaming\Code\User\settings.json
```

### 应用配置到新机器：
1. 复制整个 `D:/Ai/VSCode Config/` 目录
2. 粘贴到新机器的相同路径
3. 重启VSCode
...
```
D:\My File\AI\ContextStack\VSCode Config\
