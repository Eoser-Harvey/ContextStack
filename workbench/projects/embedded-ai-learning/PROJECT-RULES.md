...
| 层级 | 内容 | 学习方式 |
|------|------|----------|
| **主线（必须）** | TFLM 源码阅读、示例运行、算子分析 | 直接操作本地 TFLM 源码 `D:\MyFile\AI\TFLM\tflite-micro-main\` |
...
courses/
├── index.md                          # 课程索引（自动维护）
├── week01-day01-tflm-hello-world.md  # 每课一个 MD
├── week01-day02-xxx.md
└── ...
```
...
### 每篇日志必须包含
- [ ] 日期和状态（未开始/进行中/已完成）
- [ ] 对应课程链接（`[[../courses/weekXX-dayXX-xxx]]`）
- [ ] 思考题回答
- [ ] 实践结果（代码输出、实验数据）
- [ ] 学习心得
- [ ] 待解决问题清单
...
courses/week01-day01.md   ← 课程笔记（AI 讲的内容，知识沉淀）
journal/week01-day01.md   ← 学习日志（你的答题、实验、心得）
```

### AI 助教行为约束
- 每节课结束后，**必须**创建对应的 `journal/weekXX-dayXX.md` 模板
- 用户提交答题后，在日志的"AI 助教反馈"区批改
- 同步更新 `journal/index.md` 索引
