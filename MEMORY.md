...
| **User** | 完整职业画像（2026-06-12更新） | ~9年嵌入式经验：爱博精电6年（自研RTOS+DSP优化+AMP异构）+新华三3年（TSN全协议栈+L2交换机+PL管理5人）。S级能力：自研RTOS内核10KB、TSN六协议、DSP汇编/硬件加速器。详细分析：[[career-development/韩伟-完整职业画像与求职分析-20260612]] | career-development | 2026-06-12 |
