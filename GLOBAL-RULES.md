...
> **触发**：每次 AI 会话开始时，主动过一遍下列 6 项；**不是形式主义**——已记录 4 次违规教训（2026-05-19 / 2026-07-06 / 2026-07-08 / 2026-07-12），证明"加载规则 ≠ 遵守规则"，需要主动过脑的步骤。
...
**判据**：6 项全部"是/已准备"= 通过；任何一项"不确定/忘记了"= 立即重读对应铁律后再行动。
...
**最后更新**: 2026-08-20
**版本**: v3.3
**变更**: 协作模式新增「AI 行为约束自检清单」（6 项会话开始自检，对抗"加载规则 ≠ 遵守规则"漏洞，基于 4 次违规教训）；同步 v3.2 修订——记忆系统三层分工 / TODO 看板双向同步 / 费曼复述纪律与考核机制
